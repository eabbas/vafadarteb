...
<div class="w-full flex justify-center py-6 px-4">
    <div class="metronic-form-card">
        ...
        <!-- ===== فرم ===== -->
        <form action="{{route('staticUser.store')}}" method="post" enctype="multipart/form-data" class="metronic-form">
            @csrf
            ...
            <div class="form-group">
                ...
                <input required type="text" name="name" class="metronic-input" placeholder="اسم را وارد کنید">
            </div>
            ...
            <div class="form-group">
                ...
                <input required type="text" name="message" class="metronic-input" placeholder="پیام را وارد کنید">
            </div>
