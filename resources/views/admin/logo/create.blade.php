...
<div class="w-full flex justify-center py-6 px-4">
    <div class="metronic-form-card">
        ...
        <div class="metronic-form-header">
            ...
            <div>
                <h2>آپلود لوگو</h2>
                <div class="subtitle">لوگوی جدید را انتخاب و ذخیره کنید</div>
            </div>
        </div>

        <!-- ===== فرم ===== -->
        <form action="{{route('logo.store')}}" method="post" enctype="multipart/form-data" class="metronic-form">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="metronic-file-upload">
                    ...
                    <div class="file-drop-zone" id="dropZone">
                        ...
                        <div class="title">فایل را بکشید و رها کنید</div>
                        <div class="subtitle">یا برای انتخاب کلیک کنید</div>
