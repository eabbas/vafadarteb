...
<div class="w-full flex justify-center py-6 px-4">
    <div class="metronic-form-card">
        ...
        <div class="metronic-form-header">
            ...
            <div>
                <h2>برچسب محصول</h2>
                <div class="subtitle">اطلاعات برچسب محصول را وارد کنید</div>
            </div>
        </div>

        <!-- ===== فرم ===== -->
        <form action="{{route('product_label.store')}}" method="post" enctype="multipart/form-data" class="metronic-form">
            @csrf
            ...
            <div class="form-group">
                ...
                <select name="label_1" class="metronic-select">
                    <option value="special">ویژه</option>
                    <option value="best salse">پر فروش</option>
                    <option value="latest">اخیرا</option>
                    <option value="Favorite">محبوب</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="label_2" class="metronic-select">
                    <option value="special">ویژه</option>
                    <option value="best salse">پر فروش</option>
                    <option value="latest">اخیرا</option>
                    <option value="Favorite">محبوب</option>
            ...
            <div class="form-group">
                ...
                <select name="label_3" class="metronic-select">
                    <option value="special">ویژه</option>
                    <option value="best salse">پر فروش</option>
                    <option value="latest">اخیرا</option>
                    <option value="Favorite">محبوب</option>
