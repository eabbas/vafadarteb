    ...
    <div class="metronic-table-card">
        ...
        <div class="metronic-table-header">
            <div class="title-section">
                ...
                <div>
                    <h2>لیست اطلاعات پشتیبانی</h2>
                    <div class="subtitle">مدیریت و مشاهده اطلاعات پشتیبانی</div>
                </div>
            </div>
            ...
            <table class="metronic-table">
                <thead>
                    <tr>
                        ...
                        <th style="min-width:80px;">تصویر</th>
                        <th>عنوان</th>
                    ...
                    <tr>
                        <td colspan="5">
                            <div class="metronic-empty">
                                ...
                                <h3>هیچ اطلاعاتی یافت نشد</h3>
                                <p>برای شروع، روی دکمه «جدید» کلیک کنید</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
