...
<div class="w-full flex justify-center py-6 px-4">
    <div class="metronic-form-card">
        ...
        <!-- ===== فرم ===== -->
        <form action="{{route('support_information.update',['support_information'=>$support_information->id])}}" method="post" enctype="multipart/form-data" class="metronic-form">
            @csrf
            ...
            <div class="form-group">
                ...
                <input required type="text" value="{{$support_information->title}}" name="title" class="metronic-input" placeholder="عنوان را وارد کنید">
            </div>
            ...
            <div class="form-group">
                ...
                <input required type="text" value="{{$support_information->summary}}" name="summary" class="metronic-input" placeholder="خلاصه را وارد کنید">
            </div>
